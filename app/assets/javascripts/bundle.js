	...
	var TodoList = React.createClass({
	  ...
	  render: function () {
	    ...
	    var todoItems = this.state.todoItems.map(function (todoItem, idx) {
	      return React.createElement(TodoListItem, { key: todoItem.id,
	...
	var TodoListItem = React.createClass({
	  ...
	  render: function () {
	    if (this.state.clicked) {
	      var detailedView = React.createElement(
	        'div',
	        null,
	        React.createElement(TodoDetailView, { todoItem: this.props.todoItem })
	      );
	    } else {
	      var detailedView = React.createElement('div', null);
	    }
	    ...
	    return React.createElement(
	      ...
	      detailedView,
	      React.createElement(DoneButton, { todoItem: this.props.todoItem })
	    );
	  }
	...
	var TodoForm = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement('br', null),
	      'Body: ',
	      React.createElement('input', { type: 'text', value: body,
